...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "fabiolmatsuo_db_user";
    private static final String PASSWORD = "S5XKtkTHe7d0u63n";
    private static final String CLUSTER_URL = "cluster0.4d2ynzk.mongodb.net"; 
